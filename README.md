Newzzer 📰
A React-based news aggregator app that provides real-time headlines across multiple categories and countries, powered by the GNews API.
🔗 Live Demo: newzzer-frontend.onrender.com
🛠️ Tech Stack
LayerTechnologyFrontendReact, BootstrapBackendNode.js, ExpressNews SourceGNews APIHostingRender (Frontend + Backend)
🏗️ Architecture
